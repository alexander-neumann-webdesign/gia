...
export function debounce(func, wait) {
	...
	const later = () => {
		...
		if (lastArgs) {
			// ⚡ BOLT OPTIMIZATION: explicitly nullify cached references
			// to allow GC to free trapped elements, and extract to local
			// variables before execution to prevent state corruption.
			const args = lastArgs;
