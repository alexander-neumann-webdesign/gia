...
function it(i = {}, e = document.documentElement) {
  ...
  const n = [], s = `${h.get("attrPrefix")}-component`, r = A(`[${s}]`, e), o = r.length;
  for (let f = 0; f < o; f++) {
    const u = r[f];
    if (!d.get(u)) {
...
function _t(i = document.documentElement) {
  const e = A(`[${h.get("attrPrefix")}-component]`, i);
...
function E(i) {
  let e, t;
  w ? (e = w.scroll, t = w.velocity) : i && typeof i.scroll == "number" ? (e = i.scroll, t = i.velocity || 0) : (e = window.scrollY || window.pageYOffset, t = 0), R.scroll = e, R.velocity = t, ft();
}
function ut() {
...
class K {
  ...
  set ref(e) {
    const t = `${h.get("attrPrefix")}-ref`, n = A(`[${t}]`, this.element), s = /* @__PURE__ */ Object.create(null);
  ...
  y() {
    ...
    if (this.o && (this.o.forEach(this.E, this), this.o = null), this.s && (this.s.forEach(this.v, this), this.s = null), this.f) {
  ...
  observeScroll(e) {
    typeof __GIA_NANO__ < "u" && __GIA_NANO__ || typeof window > "u" || (N || (N = !0, window.lenis ? (w = window.lenis, w.on("scroll", E)) : window.addEventListener("scroll", E, { passive: !0 })), this.t || (this.t = []), this.t.indexOf(e) === -1 && this.t.push(e), p.indexOf(e) === -1 && p.push(e));
  }
  E(e, t) {
  ...
  unobserveScroll(e) {
    ...
    const t = p.indexOf(e);
    t !== -1 && (p[t] = p[p.length - 1], p.pop()), p.length === 0 && N && (N = !1, w ? (w.off("scroll", E), w = null) : window.removeEventListener("scroll", E));
  }
  ...
  observeResize(e, t) {
    ...
    let n = m.get(e);
    n || (n = [], m.set(e, n), b.observe(e)), n.indexOf(t) === -1 && n.push(t), this.o || (this.o = /* @__PURE__ */ new Map());
    let s = this.o.get(e);
  ...
  unobserveResize(e, t = null) {
    ...
    const s = m.get(e);
    s && s.length === 0 && (m.delete(e), b && b.unobserve(e));
  }
  ...
  unobserveIntersection(e, t = null) {
    ...
    n && (this.b = e, this.O = t, n.forEach(this.I, this), this.b = null, this.O = null, n.size === 0 && this.s.delete(e));
  }
  /**
  ...
  setState(e) {
    if (e)
      for (const t in e) {
        ...
        const n = e[t];
        if (this.d[t] !== n && (this.d[t] = n, this.h || (this.h = this.w || {}, this.u = this.p || {}, v.push(this), $ || ($ = !0, ot(lt))), this.h[t] = n, typeof __GIA_NANO__ > "u" || !__GIA_NANO__)) {
          const s = typeof n;
...
K.prototype.x = function() {
  const i = A("[data-action]", this.element), e = i.length;
  for (let t = 0; t < e; t++) {
...
class at {
  ...
  off(e, t) {
    ...
    if (!n) return;
    let s = t;
    t.a && t.a[e] ? (s = t.a[e], delete t.a[e]) : t.M && (s = t.M);
    const r = n.indexOf(s);
    r !== -1 && n.splice(r, 1);
  }
}
  ...
  for (let n = 0; n < i.length; n++) {
    ...
    if (s.addedNodes.length > 0)
      for (let r = 0; r < s.addedNodes.length; r++) {
        ...
        o.nodeType === Node.ELEMENT_NODE && (o.hasAttribute(e) || o.querySelector(`[${e}]`)) && O.indexOf(o) === -1 && O.push(o);
      }
  }
  S = t;
