...
function ct(i = {}, e = document.documentElement) {
  if (!i) {
...
function at(i = document.documentElement) {
...
let g = null;
const P = { scroll: 0, velocity: 0 }, M = { width: 0, height: 0 }, N = [null];
let R = !1;
const x = [];
function tt() {
  R = !1;
...
function O(i) {
  let e, t;
  g ? (e = g.scroll, t = g.velocity) : i && typeof i.scroll == "number" ? (e = i.scroll, t = i.velocity || 0) : (e = window.scrollY || window.pageYOffset, t = 0), P.scroll = e, P.velocity = t, et();
}
function nt() {
...
function S(i) {
  M.width = window.innerWidth, M.height = window.innerHeight, nt();
}
let y = null;
const m = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new Map(), it = /* @__PURE__ */ new Set(["constructor", "require", "mount", "unmount", "getRef", "setState", "stateChange", "loadScript", "loadStyle"]), z = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new Map();
function st(i) {
...
class rt {
  ...
  y() {
    ...
    if (this.t) {
      for (let e = this.t.length - 1; e >= 0; e--)
        this.unobserveScroll(this.t[e]);
      this.t = null;
    }
    if (this.e) {
      for (let e = this.e.length - 1; e >= 0; e--)
        this.unobserveWindowResize(this.e[e]);
      this.e = null;
    }
    if (this.r && (this.r.forEach(this.N, this), this.r = null), this.s && (this.s.forEach(this.I, this), this.s = null), this.a) {
  ...
  unobserveIntersection(e, t = null) {
    ...
    n && (this.b = e, this.O = t, n.forEach(this.v, this), this.b = null, this.O = null, n.size === 0 && this.s.delete(e));
  }
  /**
  ...
  setState(e) {
    if (e)
      for (const t in e) {
        ...
        const n = e[t];
        if (this.d[t] !== n && (this.d[t] = n, this.h || (this.h = this.w || {}, this.f = this.p || {}, x.push(this), R || (R = !0, X(tt))), this.h[t] = n, typeof __GIA_NANO__ > "u" || !__GIA_NANO__)) {
          const s = typeof n;
  ...
  x() {
    ...
    if (!t) {
      ...
      for (let o = 0; o < s.length; o++) {
        const r = s[o];
        !it.has(r) && !r.startsWith("_") && typeof ((n = Object.getOwnPropertyDescriptor(e, r)) == null ? void 0 : n.value) == "function" && t.push(r);
      }
      z.set(e, t);
    }
...
export {
  ...
  gt as eventbus,
  ft as getComponentFromElement,
  ct as loadComponents,
  ht as measure,
  X as mutate,
  at as removeComponents,
  ut as utils
};
