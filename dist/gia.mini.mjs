...
function ht(i = {}, e = document.documentElement) {
  if (!i) {
...
let g = null;
const P = { scroll: 0, velocity: 0 }, M = { width: 0, height: 0 }, N = [null], tt = function(i, e) {
...
function O(i) {
  let e, t;
  g ? (e = g.scroll, t = g.velocity) : i && typeof i.scroll == "number" ? (e = i.scroll, t = i.velocity || 0) : (e = window.scrollY || window.pageYOffset, t = 0), P.scroll = e, P.velocity = t, it();
}
function st() {
...
class lt {
  ...
  y() {
    ...
    if (this.t && (this.t.forEach(this.unobserveScroll, this), this.t = null), this.e && (this.e.forEach(this.unobserveWindowResize, this), this.e = null), this.r && (this.r.forEach(tt, this), this.r = null), this.s && (this.s.forEach(et, this), this.s = null), this.a) {
  ...
  observeScroll(e) {
    typeof __GIA_NANO__ < "u" && __GIA_NANO__ || typeof window > "u" || (A || (A = !0, window.lenis ? (g = window.lenis, g.on("scroll", O)) : window.addEventListener("scroll", O, { passive: !0 })), this.t || (this.t = []), this.t.indexOf(e) === -1 && this.t.push(e), d.indexOf(e) === -1 && d.push(e));
  }
  unobserveScroll(e) {
  ...
  observeWindowResize(e) {
    typeof __GIA_NANO__ < "u" && __GIA_NANO__ || typeof window > "u" || (b || (b = !0, window.addEventListener($, S, { passive: !0 })), this.e || (this.e = []), this.e.indexOf(e) === -1 && this.e.push(e), p.indexOf(e) === -1 && p.push(e));
  }
  ...
  setState(e) {
    if (e)
      for (const t in e) {
        ...
        const n = e[t];
        if (this.d[t] !== n && (this.d[t] = n, this.h || (this.h = this.w || {}, this.f = this.p || {}, x.push(this), R || (R = !0, X(nt))), this.h[t] = n, typeof __GIA_NANO__ > "u" || !__GIA_NANO__)) {
          const s = typeof n;
  ...
  x() {
    ...
    if (!t) {
      ...
      for (let o = 0; o < s.length; o++) {
        const r = s[o];
        !rt.has(r) && !r.startsWith("_") && typeof ((n = Object.getOwnPropertyDescriptor(e, r)) == null ? void 0 : n.value) == "function" && t.push(r);
      }
      L.set(e, t);
    }
