...
var G = (i, e, t) => q(i, typeof e != "symbol" ? e + "" : e, t);
...
function he(i = {}, e = document.documentElement) {
  if (!i) {
  ...
  const n = [], s = `${w.get("attrPrefix")}-component`, o = v(`[${s}]`, e), r = o.length;
  for (let f = 0; f < r; f++) {
    const u = o[f];
    if (!h.get(u)) {
...
function de(i = document.documentElement) {
  const e = v(`[${w.get("attrPrefix")}-component]`, i);
...
function Z() {
  ...
  e.length = 0, l.tempWrites = e, l.currentWrites = null, (l.reads.length > 0 || l.writes.length > 0) && C();
}
function C() {
...
function pe(i, e) {
  const t = e ? j(i, e) : i;
  return l.reads.push(t), C(), t;
}
function X(i, e) {
  const t = e ? j(i, e) : i;
  return l.writes.push(t), C(), t;
}
function ge(i) {
...
let g = null;
const P = { scroll: 0, velocity: 0 }, M = { width: 0, height: 0 }, N = [null], ee = function(i, e) {
...
function O(i) {
  let e, t;
  g ? (e = g.scroll, t = g.velocity) : i && typeof i.scroll == "number" ? (e = i.scroll, t = i.velocity || 0) : (e = window.scrollY || window.pageYOffset, t = 0), P.scroll = e, P.velocity = t, ie();
}
function se() {
...
function S(i) {
  M.width = window.innerWidth, M.height = window.innerHeight, se();
}
let y = null;
const m = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ new Set(["constructor", "require", "mount", "unmount", "getRef", "setState", "stateChange", "loadScript", "loadStyle"]), L = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new Map();
function oe(i) {
...
class le {
  ...
  set ref(e) {
    const t = `${w.get("attrPrefix")}-ref`, n = v(`[${t}]`, this.element), s = /* @__PURE__ */ Object.create(null);
  ...
  y() {
    ...
    if (this.r && (this.r.forEach(ee, this), this.r = null), this.s && (this.s.forEach(te, this), this.s = null), this.a) {
  ...
  unobserveIntersection(e, t = null) {
    ...
    n && (this.b = e, this.O = t, n.forEach(this.N, this), this.b = null, this.O = null, n.size === 0 && this.s.delete(e));
  }
  /**
  ...
  setState(e) {
    if (e)
      for (const t in e) {
        ...
        const n = e[t];
        if (this.d[t] !== n && (this.d[t] = n, this.h || (this.h = this.w || {}, this.f = this.p || {}, x.push(this), R || (R = !0, X(ne))), this.h[t] = n, typeof __GIA_NANO__ > "u" || !__GIA_NANO__)) {
          const s = typeof n;
          if (s === "boolean" || s === "string") {
            let o = B.get(t);
            o || (o = `data-${t.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase()}`, B.set(t, o)), this.f[o] = s === "boolean" ? n ? "true" : "false" : n;
          }
        }
      }
  }
  ...
  x() {
    ...
    if (!t) {
      ...
      for (let o = 0; o < s.length; o++) {
        const r = s[o];
        !re.has(r) && !r.startsWith("_") && typeof ((n = Object.getOwnPropertyDescriptor(e, r)) == null ? void 0 : n.value) == "function" && t.push(r);
      }
      L.set(e, t);
    }
...
class fe {
  ...
  off(e, t) {
    if (!t) {
      console.warn("EventBus.off requires a handler to remove a specific listener when using native EventTarget."), this.listeners[e] && (this.listeners[e].length = 0);
      return;
    }
    const n = this.listeners[e];
    if (!n) return;
    let s = t;
    t.c && t.c[e] ? (s = t.c[e], delete t.c[e]) : t.v && (s = t.v);
    const o = n.indexOf(s);
    o !== -1 && (n[o] = n[n.length - 1], n.pop());
  }
}
...
export {
  ...
  he as loadComponents,
  pe as measure,
  X as mutate,
  de as removeComponents,
  ae as utils
};
