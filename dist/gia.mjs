...
var O = (o, e, t) => q(o, typeof e != "symbol" ? e + "" : e, t);
...
function V(o = {}, e = document.documentElement) {
  ...
  for (let a = 0; a < i; a++) {
    ...
    if (!l.__gia_component__) {
      ...
      typeof o[u] == "function" ? n.push(M(l, u, o[u])) : console.warn(`Constructor "${u}" not found.`);
    }
  }
  if (e instanceof Element && e.hasAttribute(s) && !e.__gia_component__) {
    const l = e.getAttribute(s);
    typeof o[l] == "function" ? n.push(M(e, l, o[l])) : console.warn(`Constructor "${l}" not found.`);
  }
...
let m = !1, w = !1;
const y = /* @__PURE__ */ new Set(), Z = typeof navigator < "u" && !!navigator.userAgent.match(/(Android|iPod|iPhone|iPad|BlackBerry|IEMobile|Opera Mini)/i), I = Z ? "orientationchange" : "resize", C = /* @__PURE__ */ new Set();
let h = null;
const A = { scroll: 0, velocity: 0 }, z = { width: 0, height: 0 }, k = [null], Q = (o) => o(A), X = (o) => o(z), L = (o) => o(k), ee = function(o, e) {
...
function v(o) {
  let e, t;
  h ? (e = h.scroll, t = h.velocity) : o && typeof o.scroll == "number" ? (e = o.scroll, t = o.velocity || 0) : (e = window.scrollY || window.pageYOffset, t = 0), A.scroll = e, A.velocity = t, y.forEach(Q);
}
function x(o) {
  z.width = window.innerWidth, z.height = window.innerHeight, C.forEach(X);
}
let p = null;
const g = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Set(["constructor", "require", "mount", "unmount", "getRef", "setState", "stateChange", "loadScript", "loadStyle"]), T = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new Map();
function ne(o) {
...
let oe = class {
    ...
    if (r)
      for (const i in s) {
        ...
        if (a !== -1) {
          ...
          l === this._name && !this._ref[c] && (this._ref[c] = s[i]);
        } else
      ...
      for (const i in e) {
        ...
        const a = Array.isArray(e[i]);
        if (e[i] !== null && a && e[i].length > 0) {
          this._ref[i] = e[i];
          continue;
        }
        const l = `${this._name}:${i}`;
        let c = s[l] || [];
        c.length === 0 && (c = s[i] || []), this._ref[i] = a ? c : c[0] ?? null;
      }
    }
  }
  get options() {
  ...
  observeWindowResize(e) {
    typeof window > "u" || (w || (w = !0, window.addEventListener(I, x, { passive: !0 })), this._observedWindowResizeCallbacks || (this._observedWindowResizeCallbacks = /* @__PURE__ */ new Set()), this._observedWindowResizeCallbacks.add(e), C.add(e));
  }
  unobserveWindowResize(e) {
    this._observedWindowResizeCallbacks && this._observedWindowResizeCallbacks.delete(e), C.delete(e), C.size === 0 && w && (w = !1, window.removeEventListener(I, x));
  }
  observeResize(e, t) {
  ...
  observeIntersection(e, t, n = {}) {
    ...
    r || (r = { observer: new IntersectionObserver((u) => {
      for (let f = 0; f < u.length; f++) {
        const P = u[f], R = r.callbacks.get(P.target);
        R && (k[0] = P, R.forEach(L));
      }
  ...
  _autoBindFunctions() {
    ...
    if (!t) {
      ...
      for (let r = 0; r < s.length; r++) {
        const i = s[r];
        !B.has(i) && !i.startsWith("_") && typeof ((n = Object.getOwnPropertyDescriptor(e, i)) == null ? void 0 : n.value) == "function" && t.push(i);
      }
      T.set(e, t);
    }
    ...
    for (let n = 0; n < t; n++) {
      ...
      for (; i < r.length; ) {
        ...
        if (a === -1 && (a = r.length), a > i) {
          ...
          let u, f;
          c !== -1 ? (u = l.substring(0, c), f = l.substring(c + 2)) : (u = l, f = void 0), this[f] && typeof this[f] == "function" && !f.startsWith("_") && !B.has(f) ? s.addEventListener(u, this[f]) : console.warn(`Method "${f}" not found, is restricted, or is not a function in component.`);
        }
        i = a + 1;
      }
    }
...
function H() {
  typeof document > "u" || (d.get("autoMountComponents") && !b ? (b = new MutationObserver(re), b.observe(document.body, {
    childList: !0,
    subtree: !0
...
const ae = d.set;
d.set = function(o, e) {
  ae.call(this, o, e), o === "autoMountComponents" && H();
};
typeof window < "u" && setTimeout(H, 0);
export {
  oe as BaseComponent,
  he as Component,
  d as config,
