...
let x = class {
  ...
  unobserveIntersection(e, t = null) {
    ...
    n && (n.forEach((o, i) => {
      ...
      if (o.size === 0 && n.delete(i), s) {
        const c = s.callbacks.get(e);
        c && c.size === 0 && (s.callbacks.delete(e), s.observer.unobserve(e)), s.callbacks.size === 0 && (s.observer.disconnect(), b.delete(i));
      }
  ...
  setState(e) {
    let t = !1, n = this._pendingStateChanges, o = this._pendingAttributeChanges;
    for (const i in e)
      if (Object.prototype.hasOwnProperty.call(e, i)) {
        const s = e[i];
        if (this._state[i] !== s) {
          t || (t = !0, n || (n = {}, o = {}, this._pendingStateChanges = n, this._pendingAttributeChanges = o, requestAnimationFrame(() => {
            for (const a in this._pendingAttributeChanges)
              if (Object.prototype.hasOwnProperty.call(this._pendingAttributeChanges, a)) {
                const f = this._pendingAttributeChanges[a];
                this.element.getAttribute(a) !== f && this.element.setAttribute(a, f);
              }
            this.stateChange(this._pendingStateChanges), this._pendingStateChanges = null, this._pendingAttributeChanges = null;
          }))), this._state[i] = s, n[i] = s;
          const c = typeof s;
          if (c === "boolean" || c === "string") {
            let a = E.get(i);
            a || (a = `data-${i.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase()}`, E.set(i, a)), o[a] = c === "boolean" ? s ? "true" : "false" : s;
          }
        }
      }
  }
